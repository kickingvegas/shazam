[[https://melpa.org/#/shazam][file:https://melpa.org/packages/shazam-badge.svg]] [[https://stable.melpa.org/#/shazam][file:https://stable.melpa.org/packages/shazam-badge.svg]] 
* shazam.el
:PROPERTIES:
:CUSTOM_ID: shazam
:END:
...
*shazam.el* is available to install from [[https://melpa.org/#/shazam][MELPA]].
...
Identifying the current music playing is done with the command ~shazam~. Run it using your preferred key binding or via "M-x".
